...
public class Reusable_Actions_Loggers_POM {
    ...
    //selectByVisibleText
    public static void selectByVisibleText(WebDriver driver, WebElement xpath, String userData, ExtentTest logger, String elementName) {
        WebDriverWait wait = new WebDriverWait(driver, 15);
    ...
    public static void clickByIndex(WebDriver driver, WebElement xpath, int indexNumber, ExtentTest logger, String elementName) {
        ...
        try {
            wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(String.valueOf(xpath)))).get(indexNumber).click();
        } catch (Exception e) {
