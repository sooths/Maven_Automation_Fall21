...
public class GoogleSearchDataDriven {
    WebDriver driver;

    public GoogleSearchDataDriven() {
    }
    ...
    public void GoogleSearchDataDriven() throws BiffException, IOException, WriteException {
        ...
        //navigate to google
            ...
            ReusableActions.sendKeysMethod(driver, "//*[@name='q']", countries, "Search Field");
            //submit to google search button
            ReusableActions.submitMethod(driver, "//*[@name='btnK']", "Google Search Button");

            //capture the result
            String results = ReusableActions.getTextMethod(driver, "//*[@id='result-stats']", "Search Result");
